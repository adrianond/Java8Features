...
public class MapMethods {
	...
	private static void MetodoRemoveObjetoMapa() {
		...
		mapa.remove("Pessoa");
		System.out.println("mapa após de remover chave e seu valor");
		mapa.forEach((chave, valor) -> {
			System.out.println(" Nomes: "+ valor.getNome());
		});
	}
	...
	private static void MetodoRemoverMapa() {
		...
		mapa2.remove("Pessoa");
		System.out.println("mapa após de remover");
		mapa2.forEach((chave, valor) -> {
			System.out.println(" Nomes: "+ valor.getNome());
		});
	}
	...
	private static void UsoMetodoMerge() {
		...
		System.out.println("Com método putAll não insere o mapa se ja houver mapa com a mesma chave, ele substitui os valores para essa chave retida,"
				+ "este método não faz o merge de mapas e sim copia um mapa para outro");
		Map<String, Pessoa> mapa = new HashMap<>();
		mapa.put("Pessoa", new Pessoa("Cris", "Toledo", "35", "3333333333", "44444444"));
    ...
    private static void UsoMetodoMerge2() {
		...
		System.out.println("Com método merge é possível juntar/mergear valores de diferentes mapas em um mapa de acordo com a regras definidas na nossa"
				+ "merge function! ");
		Map<String, Pessoa> mapa = new HashMap<>();
		mapa.put("Pessoa", new Pessoa("Cris", "Toledo", "35", "3333333333", "44444444"));
		...
		System.out.println("tamanho do mapa: " + mapa4.size());
		System.out.println("Imprime o nome do objeto Pessoa contido no mapa4 após merge com mapa2 e os demais atributos do objeto Pessoa contido no mapa3");
		mapa4.forEach((chave, valor) -> {
		System.out.println("chave: " + chave + " " + "valor: " + valor);
		});
	}
